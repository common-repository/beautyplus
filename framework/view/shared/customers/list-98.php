...
<?php if (0 < count($customers)) {  ?>
  <h2 class="badge badge-black badge-pill __A__Badge_Big_Title"><?php esc_html_e('Customers', 'beautyplus'); ?></h2>
          ...
          <div class="__A__Item_Details">
            <div class="row">
              <div class="col-sm-12 __A__Customer_Details_Actions">
                <a href="<?php echo BeautyPlus_Helpers::secure_url('customers', esc_attr($customer['id']), array('action' => 'view', 'id' => esc_attr($customer['id']))); ?>" class="__A__StopPropagation trig"><?php esc_html_e('View Customer', 'beautyplus'); ?></a>
