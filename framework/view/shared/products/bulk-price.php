...
<div class="beautyplus-title inbrowser">
  <h3><?php esc_html_e('Change prices', 'beautyplus'); ?></h3>
</div>
...
<form action="" method="POST">
  ...
  <div class="container-fluid" id="bulk-prices">
      ...
      <div class="w-100">
        <div class="c" id="headingOne">
          <h5 class="mb-3">
            ...
            <?php esc_html_e('I want to increase the prices', 'beautyplus'); ?>
          </h5>
        </div>
      </div>
    </div>
      ...
      <div class="w-100">
            ...
            <div class="row">
              <div class="col-5">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control percent_1" name="percent_1" placeholder="<?php esc_html_e('Percent', 'beautyplus'); ?>" aria-label="<?php esc_html_e('Percent', 'beautyplus'); ?>" autofocus>
                </div>
              </div>
              <div class="col-1 text-center __A__And_Or d-flex align-items-center">
                <div class="mb-3">
                  <?php esc_html_e('AND', 'beautyplus'); ?>
                </div>
              </div>
              <div class="col-6">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control fixed_1" name="fixed_1" placeholder="<?php esc_html_e('Fixed', 'beautyplus'); ?>" aria-label="<?php esc_html_e('Fixed', 'beautyplus'); ?>">
                </div>
              </div>
            </div>
        ...
        <div class="" id="headingTwo">
          <h5 class="mb-3">
            ...
            <?php esc_html_e('I want to decrease the prices', 'beautyplus'); ?>
          </h5>
        </div>
            ...
            <div class="row">
              <div class="col-5">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control percent_2" name="percent_2" placeholder="<?php esc_html_e('Percent', 'beautyplus'); ?>" aria-label="<?php esc_html_e('Percent', 'beautyplus'); ?>" >
                </div>
              </div>
              <div class="col-1 text-center __A__And_Or d-flex align-items-center">
                <div class="mb-3">
              ...
              <div class="col-6">
                <div class="input-group mb-3">
                  ...
                  <input type="text" class="form-control fixed_2" name="fixed_2" placeholder="<?php esc_html_e('Fixed', 'beautyplus'); ?>" aria-label="<?php esc_html_e('Fixed', 'beautyplus'); ?>">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row">
      <input type="submit" class="btn btn-primary" value="<?php esc_html_e('Apply new prices', 'beautyplus'); ?>"/>
    </div>
    ...
    <div class="row mb-2">
      <h5><?php esc_html_e('Preview', 'beautyplus'); ?></h5>
    </div>
    ...
    <div class="row">
      <table class="table table-bordered">
        <thead>
          <th>
            <?php esc_html_e('Product', 'beautyplus'); ?>
          </th>
          <th class="text-right">
            <?php esc_html_e('New Regular Price', 'beautyplus'); ?>
          </th>
          <th class="text-right">
            <?php esc_html_e('New Sale Price', 'beautyplus'); ?>
          </th>
          <th class="text-right">
            <?php esc_html_e('Old Price', 'beautyplus'); ?>
          </th>
          <th class="text-right bg-light">
            <?php esc_html_e('New Price', 'beautyplus'); ?>
          </th>
        </thead>
        <tbody>
            ...
            <?php } else {  ?>
              <tr>
                ...
                <td colspan="4" class="text-muted __A__Bulk_No">
                  <?php esc_html_e("Because of this is a variable product you can't change price", 'beautyplus'); ?>
                </td>
              </tr>
            <?php }  ?>
          <?php }  ?>
