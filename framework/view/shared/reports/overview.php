...
<div id="beautyplus-reports" class="__A__GP">

  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12 col-md-offset-2 text-center">
        <div class="__A__Reports_Range btn-group" role="group" aria-label="Button group with nested dropdown">
          <a href="<?php echo BeautyPlus_Helpers::change_url('range', 'daily', 'btn btn-secondary', 'btn-dark', true); ?>"><?php esc_html_e('Daily', 'beautyplus'); ?></a>
          <a href="<?php echo BeautyPlus_Helpers::change_url('range', 'weekly', 'btn btn-secondary', 'btn-dark'); ?>"><?php esc_html_e('Weekly', 'beautyplus'); ?></a>
          <a href="<?php echo BeautyPlus_Helpers::change_url('range', 'monthly', 'btn btn-secondary', 'btn-dark'); ?>"><?php esc_html_e('Monthly', 'beautyplus'); ?></a>
          <a href="<?php echo BeautyPlus_Helpers::change_url('range', 'yearly', 'btn btn-secondary', 'btn-dark'); ?>"><?php esc_html_e('Yearly', 'beautyplus'); ?></a>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      ...
      if (100>$max_width || ( "1" === BeautyPlus::option('reports-graph', "2"))) {
        $max_width = 100;
      }?>

      <div id="__A__eeez" class="__A__eeez_Graph<?php echo esc_attr(BeautyPlus::option('reports-graph', "2")); ?>">
        <div id="__A__eee" style="width:<?php echo esc_attr($max_width); ?>%;">
          <canvas id="__A__Chart_1" width="100%" class="__A__Chart_1_<?php echo esc_attr(BeautyPlus::option('reports-graph', "2")); ?>"></canvas>
        </div>
        <script>
...
<div class="__A__Reports_Div">
  <div class="__A__Reports_Div_Inner table-responsive ">
    ...
    <table class="__A__Reports_Table table table-hover text-center">
      <thead>
        <th class="text-left"><?php esc_html_e('Date', 'beautyplus'); ?></th>
        <th><?php esc_html_e('Visitors', 'beautyplus'); ?></th>
        <th><?php esc_html_e('Orders', 'beautyplus'); ?></th>
        <th class="text-right"><?php esc_html_e('Sales', 'beautyplus'); ?> (<?php echo get_woocommerce_currency_symbol(); ?>)</th>
        <th class="text-right"><?php esc_html_e('Net Sal.', 'beautyplus'); ?> (<?php echo get_woocommerce_currency_symbol(); ?>)</th>
        <th class="text-right"><?php esc_html_e('Shipping', 'beautyplus'); ?> (<?php echo get_woocommerce_currency_symbol(); ?>)</th>
        <th class="text-right"><?php esc_html_e('Taxes', 'beautyplus'); ?> (<?php echo get_woocommerce_currency_symbol(); ?>)</th>
        <th class="text-right"><?php esc_html_e('Refunds', 'beautyplus'); ?> (<?php echo get_woocommerce_currency_symbol(); ?>)</th>
        <th class="text-right"><?php esc_html_e('Coupons', 'beautyplus'); ?> (<?php echo get_woocommerce_currency_symbol(); ?>)</th>
        <th class="text-right"><?php esc_html_e('Goals', 'beautyplus'); ?> &nbsp;(<?php echo get_woocommerce_currency_symbol(); ?>)</th>
      </thead>
      <tbody>
        <?php
        foreach ($data['results_r'] AS $date) {
          ...
          <tr>
            ...
            <td class="text-right" ><span class="__A__Goal_Bullet<?php if ($date['sales']<=$date['goal']) { echo esc_attr( ' text-danger' ); } else { echo esc_attr( ' text-success' ); } ?>"><?php echo wc_price($date['sales']-$date['goal']); ?> &nbsp; &#11044;</span></td>
...
<?php if ('yearly' !== BeautyPlus_Helpers::get("range")) { ?>
  <div class="__A__Reports_Div">
    <div class="__A__Reports_Div_Inner">
      <h6><?php esc_html_e("Conversions", 'beautyplus'); ?></h6>
...
<?php
if ("2" === BeautyPlus::option('reports-graph', "2")) {   ?>
  <script>
  jQuery(document).ready(function() {
    "use strict";
