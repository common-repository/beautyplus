...
<div id='slider2' class="d-none">
  ...
  <div class="__A__LeftMenu __A__Channels">
    <div class="text-center">
      ...
      ?>
      <img src="<?php echo esc_url_raw($beautyplus_img_src[0]) ?>" class="__A__LeftMenu_Logo"></div>
      <nav class="__A__MainMenu vertical">
        <ul>
          <li><a href="javascript:;" class="__A__Left_Search"><?php esc_html_e('Search', 'beautyplus'); ?></a></li>
          <?php echo BeautyPlus_Admin::get_menu(array('settings' => true));  ?>
          <li>
  ...
  <div id="notifications"  class="d-none">
    <div id="heading"><?php esc_html_e('Notifications', 'beautyplus'); ?>
...
<div class="beautyplus-search-1--overlay" id="beautyplus-search-1--overlay">
  <div id="beautyplus-search-1--wrapper">
    <form method="get" id="beautyplus-search-1-form" action="" onsubmit="return false;">
      <a href="#" class="beautyplus-search-1--close" id="beautyplus-search-1--close-button"><span class="dashicons dashicons-no"></span></a>
      <input type="text" value="" name="ss1" placeholder="Search..."  class="beautyplus-search-input" autofocus autocomplete="off" >
    </form>

    <div class="__A__Search_Container_Searching hidden"><?php esc_html_e('Searching...', 'beautyplus'); ?></div>
    ...
    <div class="__A__Search_Container_No">
      <div class="__A__EmptyTable d-flex align-items-center justify-content-center text-center">
        <div>  <span class="dashicons dashicons-marker"></span><br><?php _e('Nothing found', 'beautyplus'); ?></div>
      </div>
    </div>
  </div>
</div>

<?php if (BeautyPlus_Admin::is_beautyplus()) {
  wp_nonce_field( 'beautyplus-general' );
} ?>
</div>
