...
jQuery(document).ready(function() {
  ...
  jQuery.post( "<?php echo admin_url("admin-ajax.php"); ?>", {
    <?php echo BeautyPlus_Helpers::ajax_nonce();  ?>,
    _asnonce: '<?php echo wp_create_nonce( 'beautyplus-segment--customers'); ?>',
  ...
  jQuery.post( "<?php echo admin_url("admin-ajax.php"); ?>", {
    <?php echo BeautyPlus_Helpers::ajax_nonce();  ?>,
    _asnonce: '<?php echo wp_create_nonce( 'beautyplus-segment--products'); ?>',
  ...
  jQuery.post( "<?php echo admin_url("admin-ajax.php"); ?>", {
    <?php echo BeautyPlus_Helpers::ajax_nonce();  ?>,
    _asnonce: '<?php echo wp_create_nonce( 'beautyplus-segment--orders'); ?>',
    action: "beautyplus_ajax",
    segment: 'orders',
    do: 'search',
    q: '<?php echo esc_attr($term);  ?>',
