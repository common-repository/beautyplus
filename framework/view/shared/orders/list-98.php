...
<?php if (0 < count( $orders )) {  ?>
  ...
  <h2 class="badge badge-black badge-pill __A__Badge_Big_Title"><?php esc_html_e('Orders', 'beautyplus'); ?></h2>
            ...
            <div class="btnA __A__Item collapsed"  data-toggle="collapse" data-target="#order_<?php echo esc_attr($order['id'])?>" aria-expanded="false" aria-controls="order_<?php echo esc_attr($order['id'])?>"  id="item_<?php echo esc_attr($order['id'])?>">
              <div class="liste  row d-flex align-items-center">
                ...
                <div class="col __A__Col_Price __A__Col_3X text-right" data-colname='Price'>
                  <span class="beautyplus-orders--item-price"><?php echo wc_price($order['total'],array('currency'=>$order['currency'])); ?></span>
                  <br>
                ...
                <div class="row __A__Order_Items">
                  ...
                  <div class="col-sm-2 __A__Order_Address __A__Order_Actions">
                    <div class="row">
                      &nbsp;
                      <br />
                      <a href="<?php echo admin_url( 'post.php?post=' . esc_attr($order['id']). '&action=edit&beautyplus_hide' );?>" class=" __A__Ajax_Btn_SP trig"><?php esc_html_e('View order details', 'beautyplus'); ?></a>
                      <br />
                      <br />
                      ...
                      <?php } ?>
                      <a href="mailto:<?php echo sanitize_email($order['billing']['email'])?>" class="__A__Ajax_Btn_SP"><?php esc_html_e('E-mail to customer', 'beautyplus'); ?></a>
                    </div>
                  </div>
                </div>
              </div>
