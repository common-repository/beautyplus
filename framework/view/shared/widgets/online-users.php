...
<h1><?php esc_html_e('Online Visitors', 'beautyplus'); ?></h1>
...
<div id="bp-beautyplus-wdg-ov--min"><?php echo esc_html($min); ?></div>
<div id="bp-beautyplus-wdg-ov--max"><?php echo esc_html($max); ?></div>
...
jQuery(document).ready(function() {
  ...
  var opts = {
    ...
    limitMax: false,
    <?php if ('dark' === BeautyPlus::$theme) {?>  // If true, the pointer will not go past the end of the gauge
