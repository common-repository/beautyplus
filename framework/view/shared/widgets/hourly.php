...
<div class="__A__Widget_Options">
  <h1 class="float-left">
    <?php esc_html_e('Visitors', 'beautyplus'); ?>
  </h1>
  <div class="__A__Widget_Options_AutoHide float-left">
    <ul>
      <li><a class="__A__Widget_Settings_<?php echo esc_attr($args['id']); ?>_Range<?php if ('hourly' === $args['range']) echo esc_attr( ' __A__Selected' );?>" data-range='hourly' href="javascript:;"><?php esc_html_e('Hourly', 'beautyplus'); ?></a></li>
        <li><a class="__A__Widget_Settings_<?php echo esc_attr($args['id']); ?>_Range<?php if ('daily' === $args['range']) echo esc_attr( ' __A__Selected' );?>" data-range='daily' href="javascript:;"><?php esc_html_e('Daily', 'beautyplus'); ?></a></li>
          <li><a class="__A__Widget_Settings_<?php echo esc_attr($args['id']); ?>_Range<?php if ('monthly' === $args['range']) echo esc_attr( ' __A__Selected' );?>" data-range='monthly' href="javascript:;"><?php esc_html_e('Monthly', 'beautyplus'); ?></a></li>
          </ul>
        </div>
      </div>
      ...
      jQuery(document).ready(function() {
        ...
        var myChart = new Chart(ctx, {
          ...
          data: {
            ...
            datasets: [{
              <?php if ('one-shadow' === BeautyPlus::$theme) {?>
